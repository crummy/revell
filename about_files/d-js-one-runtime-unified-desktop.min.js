!function(a,c,l){"use strict";const s={};var d,p;console.warn=console.warn&&console.warn.bind(console)||console.log.bind(console),a.resolved=a.Deferred().resolve().promise(),a.rejected=a.Deferred().reject().promise(),window.requestIdleCallback=window.requestIdleCallback||function(a){return setTimeout((function(){var c=Date.now();a({didTimeout:!1,timeRemaining:function(){return Math.max(0,50-(Date.now()-c))}})}),1)},window.cancelIdleCallback=window.cancelIdleCallback||(p=function(){function e(a){var c=this.constructor;return this.then((function(l){return c.resolve(a()).then((function(){return l}))}),(function(l){return c.resolve(a()).then((function(){return c.reject(l)}))}))}function n(){}function t(a){if(!(this instanceof t))throw new TypeError("Promises must be constructed via new");if("function"!=typeof a)throw new TypeError("not a function");this._state=0,this._handled=!1,this._value=l,this._deferreds=[],u(a,this)}function o(a,c){for(;3===a._state;)a=a._value;0!==a._state?(a._handled=!0,t._immediateFn((function(){var l=1===a._state?c.onFulfilled:c.onRejected;if(null!==l){var s;try{s=l(a._value)}catch(a){return void i(c.promise,a)}r(c.promise,s)}else(1===a._state?r:i)(c.promise,a._value)}))):a._deferreds.push(c)}function r(a,c){try{if(c===a)throw new TypeError("A promise cannot be resolved with itself.");if(c&&("object"==typeof c||"function"==typeof c)){var l=c.then;if(c instanceof t)return a._state=3,a._value=c,void f(a);if("function"==typeof l)return void u(function(a,c){return function(){a.apply(c,arguments)}}(l,c),a)}a._state=1,a._value=c,f(a)}catch(c){i(a,c)}}function i(a,c){a._state=2,a._value=c,f(a)}function f(a){2===a._state&&0===a._deferreds.length&&t._immediateFn((function(){a._handled||t._unhandledRejectionFn(a._value)}));for(var c=0,l=a._deferreds.length;l>c;c++)o(a,a._deferreds[c]);a._deferreds=null}function u(a,c){var l=!1;try{a((function(a){l||(l=!0,r(c,a))}),(function(a){l||(l=!0,i(c,a))}))}catch(a){if(l)return;l=!0,i(c,a)}}var a=setTimeout;t.prototype.catch=function(a){return this.then(null,a)},t.prototype.then=function(a,c){var l=new this.constructor(n);return o(this,new function(a,c,l){this.onFulfilled="function"==typeof a?a:null,this.onRejected="function"==typeof c?c:null,this.promise=l}(a,c,l)),l},t.prototype.finally=e,t.all=function(a){return new t((function(c,l){function o(a,p){try{if(p&&("object"==typeof p||"function"==typeof p)){var h=p.then;if("function"==typeof h)return void h.call(p,(function(c){o(a,c)}),l)}s[a]=p,0==--d&&c(s)}catch(a){l(a)}}if(!a||void 0===a.length)throw new TypeError("Promise.all accepts an array");var s=Array.prototype.slice.call(a);if(0===s.length)return c([]);for(var d=s.length,p=0;s.length>p;p++)o(p,s[p])}))},t.resolve=function(a){return a&&"object"==typeof a&&a.constructor===t?a:new t((function(c){c(a)}))},t.reject=function(a){return new t((function(c,l){l(a)}))},t.race=function(a){return new t((function(c,l){for(var s=0,d=a.length;d>s;s++)a[s].then(c,l)}))},t._immediateFn="function"==typeof setImmediate&&function(a){setImmediate(a)}||function(c){a(c,0)},t._unhandledRejectionFn=function(a){void 0!==console&&console&&console.warn("Possible Unhandled Promise Rejection:",a)};var s=function(){if("undefined"!=typeof self)return self;if("undefined"!=typeof window)return window;if(void 0!==c)return c;throw Error("unable to locate global object")}();"Promise"in s?s.Promise.prototype.finally||(s.Promise.prototype.finally=e):s.Promise=t},d=void("object"==typeof exports&&"undefined"!=typeof module?p():"function"==typeof define&&define.amd?define(p):p()),void clearTimeout(d));var h={thumbnail:160,mobile:320,tablet:780,desktop:1200},handleMultisizedPath=function(a,c,l){if(function(a){return a.includes("/multi/opt/")}(a))return function(a,c){var l=h[c]||160;return a.replace(/(-)\d+(w\.[^\.]*?$)/,"$1"+l+"$2")}(a,l?"thumbnail":c);var s,d,p=/.*(dms3rep\/multi\/)(thumbnail\/|mobile\/|tablet\/|desktop\/)?[^.]*(-\d+x\d+)\.?.*/,m=a;if(!p.test(m))return c&&"thumbnail"==c?-1===m.indexOf("/d_gallery_d_thumb_")&&(m=m.replace("/d_gallery","/d_gallery_d_thumb_")):m=m.replace("/d_gallery_d_thumb_","/d_gallery"),m;if(d=(s=p.exec(m))[2]?s[2]:"",l)m=s[0],/\/import\/clib\//.test(m)||(m=m.replace(s[3],"")),m=m.replace(s[1]+d,"");else{var v="dms3rep/multi/"+d,w="dms3rep/multi/"+(c?c+"/":"");m=m.replace(v,w)}return m};String.prototype.getMultisizedPath=function(a){return handleMultisizedPath(this.toString(),a,!1)},String.prototype.revertMultisizedPath=function(){return handleMultisizedPath(this.toString(),null,!0)},c.invokeSafe=function(a,c){return getSafeFn(a,c)()},c.getSafeFn=function(c,l){return getSafe(c,l)||a.noop},c.getSafe=function(a,s){var d,p,h,m=0;for("string"==typeof a?(p=c,h=a):null!=a&&(p=a,h=s),"string"==typeof h?d=h.split("."):(d=[],p=l);d[m]!==l&&p!==l;)p=p[d[m]],m++;return p};a.extend(a,{getHeightForVisibleRows:function(a,c){var l,s=c.eq(0),d="auto";return"auto"!==a&&(l=parseInt(s.css("line-height")),isNaN(l)&&(l=1.19*parseInt(s.css("font-size"))),d=a*l+"px"),d},waitUntil:function(c){var l,s,d=a.Deferred(),p=0;return"function"==typeof c&&(l={conditionFn:c}),l=l||{},a.isPlainObject(c)&&a.extend(l,c),l.interval=c.interval||100,l.timeout=c.timeout||3e4,l.conditionFn=l.conditionFn||function(){return!0},s=window.setInterval((function(){p+=l.interval,l.conditionFn(l)?(window.clearInterval(s),d.resolve({duration:p})):p>l.timeout&&d.reject({timeout:l.timeout})}),l.interval),d.promise()},equalHeight:function(a){var c,l,s=0;a.each((function(){(l=jQuery(this)).css("minHeight",0),(c=l.height())>s&&(s=c)})),a.css("min-height",s+"px")},loadScript:function(c,l){return window.rtFlags&&window.rtFlags["runtime.load.script.native"]||window._flags&&window._flags["runtime.load.script.native"]?(a=>new Promise(((c,l)=>{if(s[a])return void c();const d=document.createElement("script");d.src=a,d.onload=()=>{s[a]=!0,c()},d.onerror=()=>{l(new Error("Failed to load script: "+a))},document.head.appendChild(d)})))(c):(l=l||{},window.assetsCacheQueryParam&&c.startsWith("/")&&!c.startsWith("//")&&(c.indexOf("?")>-1?c+=window.assetsCacheQueryParam.replace("?","&"):c+=window.assetsCacheQueryParam),l.isJSONP&&a('script[src^="'+c+'"]').length||!l.forceLoad&&s[c]?d=a.Deferred().resolve().promise():(l=a.extend(l||{},{dataType:"script",cache:!0,url:c}),d=a.ajax(l).done((function(){s[c]=!0}))),d);var d},loadCss:function(a,c){var l,s,d,p,h;for(s=document.getElementsByTagName("head")[0],h=c||{},d=0;d<a.length;d++)p=a[d],null!==document.getElementById(p.id)||((l=document.createElement("link")).setAttribute("rel","stylesheet"),l.setAttribute("type","text/css"),l.setAttribute("id",p.id),l.setAttribute("href",p.path),s.appendChild(l));h.callback&&setTimeout(h.callback,500)},isEditKeyCode:function(a){var c=a.keyCode;return c>36&&c<41||8==c||"65"==c&&a.ctrlKey}})}(jQuery,window);
/*! Native Promise Only
...
//# sourceMappingURL=d-js-one-runtime-unified-desktop.min.js.map
